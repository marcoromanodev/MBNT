...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const categoryMap = {
    ...
    'blankhoodie.html': 'sweatshirts.html',
    'dufflebag.html': 'bags.html',
    'backpack.html': 'bags.html',
    'truckerhat.html': 'hats.html',
    'camohat.html': 'hats.html',
    'blankshirt.html': 't-shirts.html',
  ...
  footerStyle.textContent = `
    ...
    .quantity-select { margin-top:10px; display:flex; justify-content:center; align-items:center; background:#000; color:#fff; gap:7.5px; padding:2.5px 5px; }
    .quantity-select button, .quantity-select .qty-value { font-size:1rem; }
    .quantity-select button { background:transparent; border:none; color:#fff; cursor:pointer; }

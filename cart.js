...
function createCartModal() {
    ...
    if (!document.getElementById('cart-modal-style')) {
        ...
        style.textContent = `
            ...
            .payment-option.shop-pay .payment-label{white-space:normal;display:flex;flex-direction:column;align-items:flex-start;overflow:visible;text-overflow:unset;} .payment-option.shop-pay .payment-label .subtext{font-size:0.8em;white-space:normal;margin-top:2px;}
            ...
            .more-logos-box{display:none;position:absolute;bottom:100%;right:0;left:auto;transform:translateX(-5px);background:#fff;padding:5px;z-index:10;border:1px solid #ccc;box-shadow:0 2px 8px rgba(0,0,0,0.15);}
            ...
            @media (max-width:480px){#cart-modal .payment-option{flex-wrap:wrap;}#cart-modal .payment-option label{flex-direction:row;align-items:center;flex-wrap:wrap;width:100%;}#cart-modal .payment-logos{margin-left:10px;justify-content:flex-start;}#cart-modal .payment-option.shop-pay .payment-label .subtext{font-size:0.6em;}}
        `;

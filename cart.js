...
function createCartModal() {
    ...
    if (!document.getElementById('cart-modal-style')) {
        ...
        style.textContent = `
            ...
            .more-logos-box{display:none;position:absolute;bottom:100%;right:0;left:auto;transform:none;background:#fff;padding:5px;z-index:10;border:1px solid #ccc;box-shadow:0 2px 8px rgba(0,0,0,0.15);}
